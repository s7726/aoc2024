...
# Shameless copy paste from the example https://github.com/stackless-dev/stacklessexamples/blob/main/examples/factorial.py
...
def process_depth(input, blinks, depth):
    total = 0
    cur_depth = 0
    added_len = 0
    ...
    total += call(process_depth, *(left, blinks_remaining, depth_remaining))
    total += call(process_depth, *(right, blinks_remaining, depth_remaining))
...
def process(input, blinks):
    ...
    return process_depth(original_stones, blinks, blinks)
